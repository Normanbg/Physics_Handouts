...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btCollisionShape*>* collision_deleter = collision_shapes.getFirst();
	p2List_item<PhysBody3D*>* body_deleter = body_shapes.getFirst();

	while(collision_deleter != nullptr)
	{
		delete collision_deleter->data;
		collision_deleter = collision_deleter->next;
	}
	while (body_deleter != nullptr)
	{
		delete body_deleter->data;
		body_deleter = body_deleter->next;
	}
